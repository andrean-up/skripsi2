...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Dashboard Cimory</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Aplikasi Stok Persediaan barang pada agen dika diva">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          <img style="margin-top:-15px; margin-right:10px;" src="assets/img/log4.ico" alt="Logo"> 
          <span style="font-size:30px">Cimory</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; Andrean Utama Putra</strong>
