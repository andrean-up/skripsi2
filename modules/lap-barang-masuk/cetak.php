...
if (isset($_GET['tgl_awal'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT a.kode_transaksi,a.tanggal_masuk,a.kode_barang,a.jumlah_masuk,b.kode_barang,b.nama_barang,b.satuan
                                    FROM db_barang_masuk as a INNER JOIN db_barang as b ON a.kode_barang=b.kode_barang
    ...
    // jika data tidak ada
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                        ...
                        <td width='40' height='13' align='center' valign='middle'>$tanggal_masuk</td>
                        ...
                        <td style='padding-right:10px;' width='10' height='13' align='center' valign='middle'>$data[jumlah_masuk]</td>
