<section class="content-header">
  <h1>
    ...
    <a class="btn btn-primary btn-social pull-right" href="?module=form-barang-keluar&form=add" title="Tambah Data" data-toggle="tooltip">
        ...
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT a.kode_transaksi,a.tanggal_keluar,a.kode_barang,a.jumlah_keluar,b.kode_barang,b.nama_barang,b.satuan
                                            FROM db_barang_keluar as a INNER JOIN db_barang as b ON a.kode_barang=b.kode_barang ORDER BY kode_transaksi DESC")
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      <td width='120' align='right' class='center'>$data[jumlah_keluar]</td>
