<script type="text/javascript">
  ...
  function cek_jumlah_keluar(input) {
    jml = document.formbarangmasuk.jumlah_keluar.value;
    var jumlah = eval(jml);
    if(jumlah < 1){
  ...
  function hitung_total_stok() {
    ...
    bil2 = document.formbarangmasuk.jumlah_keluar.value;
        ...
        <div class="box box-primary">
          ...
          <form role="form" class="form-horizontal" action="modules/barang-keluar/proses.php?act=insert" method="POST" name="formbarangmasuk">
            <div class="box-body">
              ...
              $query_id = mysqli_query($mysqli, "SELECT RIGHT(kode_transaksi,7) as kode FROM db_barang_keluar
